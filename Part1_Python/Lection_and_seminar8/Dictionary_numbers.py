...
def change_abonent():
    ...
    # Ячейка Фамилия
    lbl_last_name = Label(change_win, text="Имя", font=("Isocpeur", 10))
    ...
    # Ячейка Имя
    lbl_first_name = Label(change_win, text="Фамилия", font=("Isocpeur", 10))
    ...
    # Ячейка Отчество
    lbl_patronymic = Label(change_win, text="Номер", font=("Isocpeur", 10))
    ...
    lbl_phone_number = Label(change_win, text="ЯП", font=("Isocpeur", 10))
...
phone_book_table.column("Номер", minwidth=0, width=120, stretch=YES)
phone_book_table.column("ЯП", minwidth=0, width=120, stretch=YES)
